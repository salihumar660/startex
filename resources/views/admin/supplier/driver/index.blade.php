                        ...
                        <form id="addDriverForm" enctype="multipart/form-data">
                            ...
                            <div class="row d-flex justify-content-center align-items-center">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="charges" id="charges" class="form-control" required>
                                </div>
                            </div>
                ...
                <div class="modal-body text-dark">
                    ...
                    <div class="row d-flex justify-content-center align-items-center">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <label class="control-label">Status</label>
                            <select name="update_status" id="update_status" class="from-control">
                                <option value="Active">Active</option>
                                <option value="Block">Block</option>
                            </select>
                            ...
                            <label class="control-label">Route</label>
                            <input type="text" name="update_route" id="update_route" class="form-control" required>

                            <label class="control-label">Charges</label>
                            <input type="text" name="update_charges" id="update_charges" class="form-control" required>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.edit', function() {
            ...
            $.ajax({
                type: "GET",
                url: "edit-driver-supplier/" + userId,
                success: function(response) {
                    ...
                    $('#update_route').val(response.user.driver.route);
                    $('#update_charges').val(response.user.driver.charges);
...
<script>
    $(document).ready(function() {
        $('#updateBtn').on('click', function() {
            ...
            var charges = $('#update_charges').val();

            $('#update-message').text('Processing request, please wait...');

            $.ajax({
                url: "{{ url('/update-driver-supplier') }}",
                type: 'GET',
                data: {
                    'userId': userId,
                    'name': name,
